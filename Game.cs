...
namespace CodeRunner
{
	public class Game
	{
		...
		public static void HandleKeypress(System.Windows.Forms.KeyEventArgs e)
		{
			...
			else if (e.KeyCode==Keys.Home || e.KeyCode==Keys.NumPad7 || e.KeyCode==Keys.U || e.KeyCode==Keys.Z)
				m_nUserAction = UserAction.DigLeft;
			else if (e.KeyCode==Keys.PageUp || e.KeyCode==Keys.NumPad9 || e.KeyCode==Keys.O || e.KeyCode==Keys.X)
